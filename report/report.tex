...
\begin{abstract}
\textit{Synapse} is an LLM-based system designed to support university studies through the automatic generation of educational material. This report explores the system architecture, focusing on the integration of agentic design patterns such as \textbf{Retrieval-Augmented Generation}, \textbf{Reflection}; integration with web search services, and advanced export functionalities.
\end{abstract}
...
\begin{itemize}
    \item \textbf{RAG (Retrieval-Augmented Generation):} To ground LLM responses in user-provided documents.
    \item \textbf{Neurosymbolic AI (Reflection Pattern):} To ensure the quality and correctness of generated flashcards through a draft-critique-refine cycle.
    \item \textbf{Web Search Integration:} To supplement local knowledge with up-to-date information from the web.
    \item \textbf{Export Capabilities:} To produce interoperable study materials compatible with popular tools like Anki.
\end{itemize}
